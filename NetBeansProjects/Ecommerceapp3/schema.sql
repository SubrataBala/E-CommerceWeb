...
('Laptop', 45999.00, 'Gaming Laptop with high performance', 10, 'laptop.jpg'),
('Smartphone', 15999.00, 'Latest Android smartphone', 25, 'phone.jpg'),
('Headphones', 2999.00, 'Wireless headphones with premium sound', 50, 'headphones.jpg'),
('Watch', 8999.00, 'Smart fitness tracking watch', 30, 'watch.jpg'),
('Camera', 35999.00, 'Professional DSLR camera', 5, 'camera.jpg');

-- Insert sample user
INSERT INTO users (name, email, password, phone) VALUES
('John Doe', 'john@email.com', 'password123', '9876543210');orders
select*from orders
